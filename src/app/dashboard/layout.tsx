    ...
    <div className="flex min-h-screen bg-[#1A1208]">
      ...
      <aside className="w-64 bg-[#0F0B05] border-r border-[#C4A882]/10 flex flex-col fixed left-0 top-0 h-screen z-50">
        ...
        <div className="p-6 border-b border-[#C4A882]/10">
          <h1 className="text-2xl text-[#F5F0E8] font-display" style={{ fontFamily: 'DM Serif Display, serif' }}>
            PETRA
          </h1>
          <p className="text-[#C4A882]/50 text-xs mt-1" style={{ fontFamily: 'DM Sans, sans-serif' }}>
            Stone for home
          </p>
        </div>
          ...
          {menuItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`w-full text-left px-6 py-2.5 text-sm transition-all duration-200 flex items-center gap-3
                  ${isActive
                    ? 'text-[#E86C2F] bg-[#E86C2F]/5 border-r-2 border-[#E86C2F]'
                    : 'text-[#C4A882]/70 hover:text-[#C4A882] hover:bg-[#C4A882]/5'
                  }`}
